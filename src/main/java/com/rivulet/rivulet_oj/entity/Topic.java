...
public class Topic {
    ...
    public Topic(int topic_id, String topic_title, String topic_tag, String topic_details, String topic_input, String topic_output, String topic_sample_input, String topic_sample_output, String topic_reminder, Date topic_limit_time, String topic_limit_memory, String topic_difficulty, int topic_pass_count, int topic_onload_count) {
    ...
    public Date getTopic_limit_time() {
        return topic_limit_time;
    }

    public void setTopic_limit_time(Date topic_limit_time) {
        this.topic_limit_time = topic_limit_time;
    }
